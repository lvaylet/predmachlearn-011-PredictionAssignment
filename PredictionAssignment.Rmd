...
Perform PCA and get the number of principal components necessary for retaining 95% of the variance:

```{r}
preProcess(subset(pml_training, select=-c(classe)), method="pca")
```
